...
class PaleoVoxGUI(QMainWindow):
    ...
    def _on_reset(self):
        ...
        self.combo_def_axis.setCurrentIndex(2)
        self.spin_def_factor.setValue(0.85)
        self.combo_ero_axis.setCurrentIndex(0)
        self.spin_ero_inc.setValue(0.5)
        self.spin_rot_x.setValue(0.0)
        self.spin_rot_y.setValue(0.0)
        self.spin_rot_z.setValue(0.0)
        self.spin_frac_max.setValue(10)
        self.chk_frac_both.setChecked(False)
        self.combo_color.setCurrentIndex(0)
        self.chk_voxel_mc.setChecked(False)
        self.combo_compare_vis.setCurrentIndex(0)
        self.combo_voxel_vis.setCurrentIndex(0)
        self.chk_voxel_comp_mc.setChecked(False)
        self.spin_tsne_pp.setValue(100)
        self.spin_tsne_seed.setValue(42)
        self.spin_tsne_pct.setValue(0.5)
        self.spin_tsne_size.setValue(1.0)
        self.combo_2d_axis.setCurrentIndex(0)
        self.combo_2d_color.setCurrentIndex(0)
        self.combo_2d_marker.setCurrentIndex(0)
